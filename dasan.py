...
class TermAnnotator:
    ...
    def explain_terms(self, text: str) -> str:
        ...
        financial_terms = [
            r'P/E\s*비율', r'PER', r'PBR', r'ROE', r'ROA', r'배당수익률',
            r'ETF', r'펀드', r'옵션', r'선물', r'스왑', r'파생상품',
            r'IPO', r'M&A', r'유상증자', r'무상증자', r'자사주매입', r'자사주소각',
            r'모멘텀', r'밸류', r'그로스', r'디펜시브', r'사이클리컬',
        ]
        english_terms = [
            r'\bP/E\b', r'\bPER\b', r'\bPBR\b', r'\bROE\b', r'\bROA\b', r'\bETF\b',
            r'\bIPO\b', r'\bM&A\b', r'\bBeta\b', r'\bAlpha\b', r'\bSharpe\s*Ratio\b',
            r'\bVolatility\b', r'\bDividend\b', r'\bMomentum\b', r'\bGrowth\b',
        ]

        annotated_text = text
        explained_terms = set()

        for patterns in [financial_terms, english_terms]:
